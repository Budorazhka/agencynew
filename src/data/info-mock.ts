...
export const NEWS_MOCK: NewsArticle[] = [
  ...
  },
  {
    ...
    body: 'Застройщик ГК «РосСтрой» открыл продажи в ЖК «Солнечный берег» (Москва, СЗАО). Доступны 1–3к квартиры от 7,2 млн ₽. Срок сдачи — Q3 2028. В системе добавлено 48 объектов в каталог.',
    category: 'developer',
  ...
  },
  {
    ...
    body: 'Санкт-Петербургский офис закрыл 18 сделок за февраль — лучший результат за 2 года. Топ-менеджер: Наталья Громова (5 сделок). Суммарная комиссия по офису — 2,1 млн ₽. Поздравляем команду!',
    category: 'company',
