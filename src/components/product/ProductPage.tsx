      ...
      <div className="leads-page-root min-h-screen">
        ...
        <div className="leads-page relative z-10 p-6 lg:p-8 space-y-4">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="text-[color:var(--app-text-muted)] font-medium">МЛМ-аналитика</span>
          </div>
    ...
    <div className="leads-page-root min-h-screen">
      ...
      <div className="leads-page relative z-10 flex min-h-[calc(100vh-8rem)] flex-col items-center justify-center p-6 lg:p-8">
        <div className="w-full max-w-2xl space-y-10 text-center">
          <div>
            <p className="text-xs uppercase tracking-widest text-[color:var(--hub-stat-label)] mb-1">Панель управления</p>
            <h1 className="text-3xl font-bold text-[color:var(--app-text)]">Продукт</h1>
          ...
          >
            ...
            <p className="text-[10px] font-semibold uppercase tracking-[0.28em] text-[color:var(--workspace-text-muted)]">
              Активный модуль
            </p>
            <h3 className="mt-2 text-lg font-bold text-[color:var(--app-text)]">МЛМ-аналитика</h3>
            <p className="mt-2 text-sm leading-6 text-[color:var(--hub-body)]">
              KPI, партнёры, воронка и активность
            </p>
            <div className="mt-6 inline-flex items-center gap-2 rounded-full border border-[color:var(--hub-card-border)] bg-[var(--nav-item-bg-active)] px-4 py-2 text-xs font-semibold text-[color:var(--app-text-muted)] transition-all group-hover:border-[color:var(--hub-card-border-hover)] group-hover:bg-[var(--nav-item-bg-active)]">
              Открыть
          ...
          >
            ...
            <h3 className="mt-2 text-lg font-bold text-[color:var(--app-text)]">Объекты</h3>
            <p className="mt-2 text-sm leading-6 text-[color:var(--hub-body)]">
