...
import { ChevronRight, ExternalLink, List, Send } from 'lucide-react'
      ...
      <div className="flex w-full flex-1 flex-col">
        <div className="flex w-full flex-col gap-8 px-5 py-6 pb-10 md:gap-10 md:px-8 md:py-8 md:pb-12">
          <section className="w-full space-y-2">
            <h1 className="text-3xl font-extrabold uppercase leading-tight tracking-tight text-[color:var(--theme-accent-heading)] sm:text-4xl md:text-[44px] lg:text-[52px]">
              {title}
            </h1>
          ...
          <section className="grid w-full grid-cols-1 gap-5 md:grid-cols-2 md:gap-6">
            ...
            >
              <div className="flex items-start justify-between">
                <List className="size-9 text-[color:var(--theme-accent-icon-dim)] md:size-10" strokeWidth={1.25} />
            ...
            >
              <div className="flex items-start justify-between">
                <Send className="size-9 text-[color:var(--gold)] md:size-10" strokeWidth={1.35} />
                <ExternalLink className="size-5 text-[color:var(--theme-accent-icon-dim)]" strokeWidth={1.5} />
              </div>
              <div className="space-y-5 md:space-y-6">
                ...
                <span className="inline-flex w-fit border border-[color:var(--hub-card-border-hover)] px-5 py-2 text-[10px] font-bold uppercase tracking-widest text-[color:var(--theme-accent-heading)] transition-all group-hover:bg-[var(--gold)] group-hover:text-[color:var(--hub-tile-icon-hover-fg)] md:px-6">
                  Быстрый запуск
                </span>
              </div>
            </button>
          ...
          <section className="grid w-full grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(260px,340px)] xl:gap-8">
            <div className="min-w-0 overflow-hidden bg-[var(--green-card)] gold-inner-glow">
              <div className="flex flex-wrap items-center justify-between gap-2 border-b border-[color:var(--divider-subtle)] px-5 py-4 md:px-8 md:py-6">
                <h3 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[color:var(--theme-accent-heading)]">
            ...
            <div className="flex min-h-[280px] flex-col justify-between bg-[var(--green-card)] p-6 gold-inner-glow md:min-h-0 md:p-8">
              <div>
                <h3 className="mb-6 text-[10px] font-bold uppercase tracking-[0.2em] text-[color:var(--theme-accent-heading)] md:mb-8">
                  Статистика охвата
                </h3>
                <div className="flex flex-wrap items-baseline gap-2">
                  <span className="text-5xl font-extrabold tracking-tighter text-[color:var(--app-text)] md:text-6xl">84%</span>
                  <span className="text-xs font-bold text-[color:var(--theme-accent-heading)]">+12.4%</span>
                </div>
