...
export const DASHBOARD_BLOCKS: Record<AccountType, DashboardBlockConfig[]> = {
  agency: [
    ...
    { id: 'personnel', label: 'Персонал', luxurySubtitle: 'Команда Мастеров', description: 'Команда и роли', route: '/dashboard/team/org', icon: 'Users', gemColor: 'emerald', visible: true },
    { id: 'training', label: 'Обучение', luxurySubtitle: 'Академия Дилеров', description: 'Курсы и материалы', route: '/dashboard/learning', icon: 'GraduationCap', gemColor: 'topaz', visible: true },
  ...
  realtor: [
    ...
    { id: 'personnel', label: 'Персонал', luxurySubtitle: 'Профиль и команда', description: 'Профиль и команда', route: '/dashboard/team/org', icon: 'Users', gemColor: 'emerald', visible: true },
    { id: 'training', label: 'Обучение', luxurySubtitle: 'Обучение', description: 'Обучение', route: '/dashboard/learning', icon: 'GraduationCap', gemColor: 'topaz', visible: true },
  ...
  internal: [
    ...
    { id: 'personnel', label: 'Персонал', luxurySubtitle: 'Команда Мастеров', description: 'Команда и доступы', route: '/dashboard/team/org', icon: 'Users', gemColor: 'emerald', visible: true },
    { id: 'training', label: 'Обучение', luxurySubtitle: 'Академия Дилеров', description: 'LMS', route: '/dashboard/learning', icon: 'GraduationCap', gemColor: 'topaz', visible: true },
